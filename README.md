...
1. Wait about _one minute_, then refresh this page for the next step.
   > Turning on GitHub Pages creates a deployment of your repository. It may take up to a minute to respond as it awaits the deployment. Future steps will be about 20 seconds; this step is slower.
